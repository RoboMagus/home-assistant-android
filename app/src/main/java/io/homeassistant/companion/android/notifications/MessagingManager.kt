...
class MessagingManager @Inject constructor(
    ...
    private suspend fun setAppLock(data: Map<String, String>) {
        ...
        val serverId = data[THIS_SERVER_ID]!!.toInt()
        Log.d(TAG, "setAppLock: appLockEnableValue: $appLockEnableValue, appLockTimeoutValue: $appLockTimeoutValue, homeBypassEnableValue: $homeBypassEnableValue, canAuth: $canAuth, serverId: $serverId")
        if (canAuth) {
